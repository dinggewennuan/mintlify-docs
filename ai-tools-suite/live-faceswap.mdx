...
<Warning>Generated resources (images, videos, audio) are valid for 7 days. Please save related resources promptly to prevent expiration.</Warning>
...
As shown in the figure link, `channel_id`, `front_user_id`, and `front_rtc_token` correspond to the Channel, User ID, and Token input fields on the page respectively.
